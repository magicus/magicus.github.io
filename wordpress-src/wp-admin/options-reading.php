...
<input type="hidden" name="page_options" value="posts_per_page,posts_per_rss,rss_language,rss_use_excerpt,blog_charset,gzipcompression,show_on_front,page_on_front,page_for_posts" />
